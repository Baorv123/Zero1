...
# Mã nguồn trên shop nhằm mục đích học tập nên anh em không nên đem đi bán và lạm dụng source đi lùa gà nếu bị phát hiện thì sáng mai ngủ dậy bạn sẽ mất trinh đít
# Source trên shop anh em mua về là up lên github thì nhớ obf lại nhé và có thể tham khảo Moonsec V3 ; luaobfuscator.com ; Base64 v.v hoặc có tiền thì mua lura.ph
# Ủng hộ tôi bằng cách truy cập shop https://ducdesigner.site để mua acc hoặc sử dụng dịch vụ tạo website tại shop này luôn rất chân thành cảm ơn .

local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/tbao143/Library-ui/refs/heads/main/Redzhubui"))()
local Window = redzlib:MakeWindow({
   Title = "Zero-Robloxhud ",
   SubTitle = "by Zero",
